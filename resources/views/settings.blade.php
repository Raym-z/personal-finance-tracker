                        ...
                        <form method="POST" action="{{ route('settings.custom-tags') }}">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" id="new_tag_name" name="tag_name" class="form-control"
                                        placeholder="e.g., Coffee, Gym, Netflix" maxlength="50" required>
                                </div>
                                <div class="col-md-4 mb-3">
                                    <label for="new_tag_type" class="form-label">Type</label>
                                    <select id="new_tag_type" name="tag_type" class="form-select" required>
                                ...
                                <div class="col-md-2 mb-3">
                                    ...
                                    <input type="color" id="new_tag_color" name="tag_color"
                                        class="form-control form-control-color" value="#6c757d"
                                        style="width: 100%; height: 38px;">
                                </div>
                            </div>
                            <button type="submit" class="btn btn-primary">Add Custom Tag</button>
                        </form>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="d-flex gap-2 align-items-center">
                                            ...
                                            <input type="text" class="form-control"
                                                value="{{ $tagColors[$tag] ?? '#6c757d' }}"
                                                onchange="updateColorPicker('{{ $tag }}', this.value)"
